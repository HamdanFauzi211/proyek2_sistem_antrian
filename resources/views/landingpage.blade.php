...
<html lang="en">
    <head>
        ...
        <title>Klinik Hewan Kucing</title>
        <!-- Favicon-->
        ...
        <!-- link css dari folder assets -->
        <link href="assets/css/sstyles.css" rel="stylesheet" />
    </head>
    <body id="page-top">
        <!-- Navigation-->
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">Klinik Hewan Kucing</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Klinik Hewan Kucing</h1>
                <!-- Icon Divider-->
